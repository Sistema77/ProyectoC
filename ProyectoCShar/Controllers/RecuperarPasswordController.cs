...
namespace ProyectoCShar.Controllers
{
    public class RecuperarPasswordController : Controller
    {
        ...
        public IActionResult MostrarVistaRecuperar([FromQuery(Name = "token")] string token)
        {
            ...
            try
            {
                Logs.log("Iniciol procesar a recuperar Contraseña");
                ...
                else
                {
                    ...
                    Logs.log("El enlace de recuperación no es válido o el usuario no se ha encontrado");
        ...
        public IActionResult ProcesarRecuperacionContraseña(UsuarioDTO usuarioDTO)
        {
            try
            {
                ...
                if (usuarioExistente == null)
                {
                    ...
                    Logs.log("El enlace de recuperación no es válido");
                ...
                if (usuarioExistente.expiracion_token.HasValue && usuarioExistente.expiracion_token.Value < DateTime.Now)
                {
                    ...
                    Logs.log("El enlace de recuperación ha expirado");
                ...
                if (modificadaPassword)
                {
                    ...
                    Logs.log("Contraseña modificada OK");
                ...
                else
                {
                    ...
                    Logs.log("Error al cambiar de contraseña");
        ...
        public IActionResult ProcesarInicioRecuperacion([Bind("email")] UsuarioDTO usuarioDTO)
        {
            try
            {
                ...
                if (envioConExito)
                {
                    ...
                    Logs.log("Proceso de recuperación OK");
                ...
                else
                {
                    ...
                    Logs.log("No se inició el proceso de recuperación, cuenta de correo electrónico no encontrada.");
                }
